...
public class VtSegundaController implements Initializable {
    ...
    @FXML
    private void showVerAlbunes() throws IOException{
        App.setRoot("VtMisAlbunes");
    }
    @FXML
    private void showBiblioteca() throws IOException{
        App.setRoot("VtBiblioteca");
    }
